...
class Progression
{
    ...
    public function setNiveau(int $v): static { $this->niveau = $v; return $this; }
    ...
    public function setDateObtention(?\DateTimeInterface $v): static { $this->dateObtention = $v; return $this; }
    public function getUpdatedAt(): ?\DateTimeInterface { return $this->updatedAt; }

    public function getEtatBadge(): string
    {
        return match ($this->etat) {
            self::ETAT_NON_COMMENCE => 'secondary', self::ETAT_EN_COURS => 'primary',
            self::ETAT_COMPLETE => 'success', self::ETAT_CERTIFIE => 'warning', default => 'secondary',
        };
    }
}
